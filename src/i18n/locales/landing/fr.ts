...
export const landingFr: LandingTranslations = {
  ...
  hero: {
    ...
    primaryCta: 'Commencez votre essai gratuit de 3 jours',
  ...
  whyChoose: {
    statsCaption: 'Utilisé par des traders des fournisseurs de signaux Telegram les plus populaires',
    stats: [
      { label: 'Traders', value: '30K+' },
      { label: 'Courtiers connectés', value: '25K+' },
      { label: 'Canaux Telegram actifs', value: '150K+' },
      { label: 'Trades ouverts', value: '500K+' },
    ],
  ...
  comparison: {
    ...
    cta: 'Commencez votre essai gratuit de 3 jours',
    rows: [
      {
  ...
  footer: {
    cta: {
      ...
      primary: 'Commencez votre essai gratuit de 3 jours',
