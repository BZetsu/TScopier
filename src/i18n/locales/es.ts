...
export const es: Translations = {
  ...
  brokersPage: {
    title: 'Brokers FxSocket (MT5)',
    subtitle: 'Conecta y prueba terminales MT5 en la nube de FxSocket junto a tus brokers legacy mt4api.dev.',
    mt5OnlyNote: 'FxSocket solo admite MT5. El broker legacy puede ser MT4 — quote y resumen funcionan; el trade demo se omite en MT4.',
    apiKeyRotationNote: 'Tras rotar la API key de FxSocket, espera ~5 minutos. Respuestas 5xx breves durante el reinicio son normales.',
    ...
    sectionAccounts: 'Cuentas FxSocket',
    sectionCompare: 'Comparación lado a lado',
    sectionRawLog: 'Log API en bruto',
    connectTitle: 'Conectar MT5 vía FxSocket',
    labelField: 'Etiqueta',
    ...
    noAccounts: 'Aún no hay cuentas FxSocket. Conecta una demo para empezar.',
    compareFxAccount: 'Cuenta FxSocket',
    ...
    demoTradeBody: 'Envía un micro-lote de compra en FxSocket y el broker legacy demo (solo MT5). Solo en cuentas demo que controles.',
    ...
    loadError: 'No se pudieron cargar las cuentas FxSocket.',
    connectError: 'Error al conectar.',
    deleteConfirm: '¿Eliminar esta cuenta FxSocket de TSCopier?',
    selectFxAccount: 'Seleccionar cuenta FxSocket',
    ...
    docsEndpointNote: 'Las llamadas usan https://api.fxsocket.com/mt5/{account_id}/… según el Request Builder. Sin CORS — van vía Edge.',
    linkExistingTitle: 'Avanzado: vincular cuenta ya conectada en FxSocket',
    existingUuidField: 'UUID de cuenta (página Accounts de FxSocket)',
  ...
  pages: {
    ...
    brokers: {
      title: 'Brokers',
      description: 'Sandbox FxSocket MT5 — conectar, diagnosticar y comparar con mt4api.dev legacy.',
    },
    contactSupport: {
