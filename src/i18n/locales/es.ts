...
export const es: Translations = {
  ...
  affiliate: {
    ...
    payoutEmail: 'Email de pago (Fase 1 pagos manuales)',
    payoutEmailHint: 'Usa el correo donde tu equipo financiero enviará los pagos.',
    savePayoutEmail: 'Guardar email de pago',
    referrals: 'Referidos',
