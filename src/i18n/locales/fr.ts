...
export const fr: Translations = {
  ...
  affiliate: {
    ...
    payoutEmail: 'Email de paiement (Phase 1 paiements manuels)',
    payoutEmailHint: 'Utilisez l’adresse où votre équipe finance enverra les paiements.',
    savePayoutEmail: 'Enregistrer l’email de paiement',
