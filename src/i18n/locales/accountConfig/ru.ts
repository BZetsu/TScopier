...
export const accountConfigRu: AccountConfigBundleTranslations = {
  accountConfig: {
    ...
    brokerList: {
      ...
      statusHealthy: 'Исправен',
      statusUnhealthy: 'Неисправен',
      statusHealthChecking: 'Проверка…',
      ...
      connectErrorThrottled:
        'Слишком много запросов на подключение за короткое время. Подождите около минуты и попробуйте снова.',
      connectErrorUnknown:
