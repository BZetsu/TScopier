...
export const configureModalEs: ConfigureModalTranslations = {
  ...
  managePresetsHint: 'Aplica un preset a este canal, o edita y elimina presets guardados.',
  managePresetsApplyHint: 'Haz clic en un preset para aplicarlo a este canal.',
  managePresetsEdit: 'Editar preset',
  managePresetsDelete: 'Eliminar preset',
  editPresetTitle: 'Editar preset',
  editPresetAction: 'Guardar cambios',
  deletePresetTitle: '¿Eliminar preset?',
  deletePresetConfirm: '¿Eliminar el preset "{name}"? Esta acción no se puede deshacer.',
  deletePresetAction: 'Eliminar',
  presetDeleted: 'Preset eliminado',
  exportPresets: 'Exportar presets',
  importPresets: 'Importar presets',
  exportPresetsTitle: 'Exportar presets',
  exportPresetsNameLabel: 'Nombre de exportación',
  exportPresetsNamePlaceholder: 'p. ej. mis-presets',
  exportPresetsAction: 'Exportar',
  exportPresetsSelectHint: 'Elige qué presets incluir en la exportación.',
  exportPresetsSelectAll: 'Seleccionar todos',
  exportPresetsSelectNone: 'Seleccionar ninguno',
  presetsExported: 'Presets exportados',
  presetsImported: 'Se importaron {count} preset(s)',
  presetsImportFailed: 'No se pudieron importar los presets',
  ...
  manualSubTabs: {
    ...
    management: 'Gestión',
    filters: 'Filtros',
    aiTraining: 'Ejemplos de señales',
  },
  aiTraining: {
    ...
    signalExamplesTitle: 'Ejemplos de señales',
    signalExamplesIntro:
      'Los mensajes etiquetados de este canal enseñan al copiador a leer sus señales en cualquier idioma. Los ejemplos se crean automáticamente al entrenar.',
    signalExamplesHint:
      'Cada ejemplo empareja un mensaje real del canal con cómo debe interpretarlo el copiador (entrada, actualización o ignorar). Usado para análisis IA — no se envía al bróker.',
    signalExamplesEmpty: 'Sin ejemplos de señales',
    signalExamplesEmptyHint:
      'Entrena este canal para analizar mensajes recientes y crear ejemplos etiquetados.',
    signalExamplesRefresh: 'Actualizar',
    signalExamplesCount: '{count} ejemplos del entrenamiento',
    signalExamplesLoadError: 'No se pudieron cargar los ejemplos',
    exampleLabelEntry: 'Entrada',
    exampleLabelUpdate: 'Actualización',
    exampleLabelIgnore: 'Ignorar',
    trainButton: 'Detección automática',
    training: 'Detectando...',
    ...
    trainFailed: 'El entrenamiento no se completó. Comprueba tu conexión e inténtalo de nuevo.',
  ...
  risk: {
    ...
    minLotPartialCloseWarning:
      'Tu lote por operación es 0.01 (mínimo del bróker). Instrucciones del canal como “cerrar la mitad”, “cierre parcial” o “tomar beneficios parciales” no pueden dejar una posición más pequeña: el copiador cerrará toda la operación. Aumenta el lote o pon Close half / partial en Ignore para este canal.',
    fieldErrors: {
      ...
      fixBeforeSave: 'Corrige los campos de Riesgo resaltados antes de guardar.',
    },
    lotCalculator: {
