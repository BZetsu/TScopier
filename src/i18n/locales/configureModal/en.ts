...
export const configureModalEn: ConfigureModalTranslations = {
  ...
  channels: {
    ...
    pickHint: 'Check channels to copy their signals to this account. None are connected by default.',
    keywordFilters: 'Channel keyword filters',
    allAllowed: 'All categories allowed',
    ignoredAcross: '{total} ignored across all channels',
    filtersIntro:
      'Mark a category as Ignore to skip matching instructions from that channel on this broker (trades keep running). Ignoring Close full position also blocks generic "close" and "close all" messages.',
    selectChannelFirst: 'Select at least one channel above to configure its filters.',
  },
  channelFilters: {
