...
export const configureModalEn: ConfigureModalTranslations = {
  ...
  cancel: 'Cancel',
  save: 'Save',
  channelsSidebar: 'Linked channels',
  selectChannelToConfigure: 'Select or link a channel to configure its trading settings.',
  copyFromChannel: 'Copy from',
  copyFromChannelPlaceholder: 'Choose channel…',
  copyFromChannelConfirm: 'Replace this channel’s settings with a copy from "{name}"?',
  tabs: {
    trade: 'Trade',
    channels: 'Channels',
  },
