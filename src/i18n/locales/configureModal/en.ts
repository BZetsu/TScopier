...
export const configureModalEn: ConfigureModalTranslations = {
  ...
  managePresetsHint: 'Apply a preset to this channel, or edit and delete saved presets.',
  managePresetsApplyHint: 'Click a preset to apply it to this channel.',
  managePresetsEdit: 'Edit preset',
  managePresetsDelete: 'Delete preset',
  editPresetTitle: 'Edit preset',
  editPresetAction: 'Save changes',
  deletePresetTitle: 'Delete preset?',
  deletePresetConfirm: 'Delete preset "{name}"? This cannot be undone.',
  deletePresetAction: 'Delete',
  presetDeleted: 'Preset deleted',
  exportPresets: 'Export presets',
  importPresets: 'Import presets',
  exportPresetsTitle: 'Export presets',
  exportPresetsNameLabel: 'Export name',
  exportPresetsNamePlaceholder: 'e.g. my-trading-presets',
  exportPresetsAction: 'Export',
  exportPresetsSelectHint: 'Choose which presets to include in the export.',
  exportPresetsSelectAll: 'Select all',
  exportPresetsSelectNone: 'Select none',
  presetsExported: 'Presets exported',
  presetsImported: 'Imported {count} preset(s)',
  presetsImportFailed: 'Could not import presets',
  ...
  risk: {
    ...
    minLotPartialCloseWarning:
      'Your lot per trade is 0.01 (broker minimum). Channel instructions like “close half”, “close partial”, or “take partial profits” cannot leave a smaller position — the copier will close the full trade. Increase lot size, or set Close half / partial to Ignore for this channel.',
    fieldErrors: {
