...
export const configureModalFr: ConfigureModalTranslations = {
  ...
  stops: {
    ...
    maxRiskToggle: 'Activer le risque maximum',
    ...
    pausedRiskBanner: 'Risque maximum atteint — les nouvelles entrées sont en pause jusqu\'au prochaine période.',
