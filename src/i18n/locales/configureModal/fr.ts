...
export const configureModalFr: ConfigureModalTranslations = {
  ...
  managePresetsHint: 'Appliquez un preset à ce canal, ou modifiez et supprimez les presets enregistrés.',
  managePresetsApplyHint: 'Cliquez sur un preset pour l’appliquer à ce canal.',
  managePresetsEdit: 'Modifier le preset',
  managePresetsDelete: 'Supprimer le preset',
  editPresetTitle: 'Modifier le preset',
  editPresetAction: 'Enregistrer',
  deletePresetTitle: 'Supprimer le preset ?',
  deletePresetConfirm: 'Supprimer le preset « {name} » ? Cette action est irréversible.',
  deletePresetAction: 'Supprimer',
  presetDeleted: 'Preset supprimé',
  exportPresets: 'Exporter les presets',
  importPresets: 'Importer des presets',
  exportPresetsTitle: 'Exporter les presets',
  exportPresetsNameLabel: 'Nom de l’export',
  exportPresetsNamePlaceholder: 'ex. mes-presets',
  exportPresetsAction: 'Exporter',
  exportPresetsSelectHint: 'Choisissez les presets à inclure dans l’export.',
  exportPresetsSelectAll: 'Tout sélectionner',
  exportPresetsSelectNone: 'Tout désélectionner',
  presetsExported: 'Presets exportés',
  presetsImported: '{count} preset(s) importé(s)',
  presetsImportFailed: 'Impossible d’importer les presets',
  ...
  aiTraining: {
    ...
    trainFailed: 'L’entraînement n’a pas abouti. Vérifiez votre connexion et réessayez.',
  ...
  channelSymbols: {
    title: 'Filtres de symboles',
    intro:
      'Les symboles du signal sont automatiquement associés aux noms d’instruments de votre broker à la connexion (préfixes/suffixes courants comme XAUUSD+ ou BTCUSDm). Utilisez les champs ci-dessous uniquement pour autoriser ou bloquer des symboles sur ce canal.',
  ...
  risk: {
    ...
    fieldErrors: {
      ...
      fixBeforeSave: 'Corrigez les champs Risque en surbrillance avant d’enregistrer.',
    },
    lotCalculator: {
