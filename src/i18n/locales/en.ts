...
export const en: Translations = {
  ...
  affiliate: {
    ...
    copyLink: 'Copy link',
    payoutEmail: 'Payout email (Phase 1 manual payouts)',
    payoutEmailHint: 'Use the address your finance team pays out to (PayPal or preferred payout channel).',
    savePayoutEmail: 'Save payout email',
    referrals: 'Referrals',
