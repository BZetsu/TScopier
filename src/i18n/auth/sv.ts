...
export const authSv: AuthTranslations = {
  ...
  forgotPassword: {
    ...
    sendError: 'Kunde inte skicka återställningsmejl. Försök igen om en stund.',
  ...
  resetPassword: {
    ...
    passwordHint: 'Minst 6 tecken med versal, gemen, siffra och symbol',
    passwordTooShort: 'Lösenordet måste vara minst 6 tecken',
    passwordTooWeak: 'Lösenordet är för svagt. Använd versal, gemen, siffra och symbol.',
    passwordMismatch: 'Lösenorden matchar inte',
    submit: 'Uppdatera lösenord',
    successHeading: 'Lösenord uppdaterat',
    successSubtitle: 'Ditt nya lösenord är inställt. Omdirigerar till inloggning…',
  ...
  signup: {
    ...
    disposableEmailNotAllowed: 'Engångs-e-postadresser är inte tillåtna',
    submit: 'Skapa konto',
    terms: {
