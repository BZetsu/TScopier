...
export const authNl: AuthTranslations = {
  ...
  forgotPassword: {
    ...
    sendError: 'Kon geen reset-e-mail versturen. Probeer het zo meteen opnieuw.',
  ...
  resetPassword: {
    ...
    passwordHint: 'Minimaal 6 tekens met hoofdletter, kleine letter, cijfer en symbool',
    passwordTooShort: 'Wachtwoord moet minimaal 6 tekens bevatten',
    passwordTooWeak: 'Wachtwoord is te zwak. Gebruik hoofdletter, kleine letter, cijfer en symbool.',
    passwordMismatch: 'Wachtwoorden komen niet overeen',
    submit: 'Wachtwoord bijwerken',
    successHeading: 'Wachtwoord bijgewerkt',
    successSubtitle: 'Je nieuwe wachtwoord is ingesteld. Je wordt doorgestuurd naar inloggen…',
  ...
  signup: {
    ...
    disposableEmailNotAllowed: 'Wegwerp-e-mailadressen zijn niet toegestaan',
