...
export const authEn: AuthTranslations = {
  ...
  forgotPassword: {
    ...
    sendError: 'Could not send reset email. Please try again in a moment.',
  ...
  resetPassword: {
    ...
    successSubtitle: 'Your new password is set. Redirecting you to sign in…',
  ...
  welcome: {
    ...
    subtitle: 'Your account is ready. Start your 3-day free trial or choose a plan to copy Telegram signals to your broker.',
    steps: [
