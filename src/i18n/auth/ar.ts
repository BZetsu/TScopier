...
export const authAr: AuthTranslations = {
  ...
  resetPassword: {
    ...
    passwordHint: '6 أحرف على الأقل مع حرف كبير وصغير ورقم ورمز',
    passwordTooShort: 'يجب أن تكون كلمة المرور 6 أحرف على الأقل',
    passwordTooWeak: 'كلمة المرور ضعيفة جداً. استخدم حرفاً كبيراً وصغيراً ورقماً ورمزاً.',
  ...
  signup: {
    ...
    passwordTooWeak: 'كلمة المرور ضعيفة جداً. استخدم حرفاً كبيراً وصغيراً ورقماً ورمزاً.',
    passwordMismatch: 'كلمتا المرور غير متطابقتين',
    emailNotAllowed: 'عنوان البريد الإلكتروني هذا غير مسموح به',
    disposableEmailNotAllowed: 'عناوين البريد الإلكتروني المؤقتة غير مسموح بها',
    submit: 'إنشاء حساب',
    terms: {
