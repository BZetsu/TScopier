      ...
      <table className="w-full min-w-[640px] text-start text-sm">
        <thead>
          <tr className="border-b border-neutral-200 text-xs font-semibold uppercase tracking-wide text-neutral-500 dark:border-neutral-800 dark:text-neutral-400">
            ...
            <th className="px-4 py-3 text-end">{labels.roi}</th>
            <th className="px-4 py-3 text-end">{labels.winRate}</th>
            <th className="px-4 py-3 text-end">{labels.maxDrawdown}</th>
          ...
          {accounts.map((account) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-3 text-end tabular-nums">{formatMoney(equity)}</td>
                <td
                ...
                <td className="px-4 py-3 text-end tabular-nums">{formatPct(winRate, 0)}</td>
                <td
