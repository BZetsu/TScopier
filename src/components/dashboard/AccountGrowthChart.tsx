...
export function AccountGrowthChart({ data, series, loading }: AccountGrowthChartProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-neutral-200 p-4 sm:p-5 min-w-0">
      <div className="mb-4">
        <h2 className="text-sm font-semibold text-neutral-900">Account growth</h2>
      ...
      {loading ? (
        ...
        <div className="h-64 flex items-center justify-center text-sm text-neutral-400 text-center px-6">
