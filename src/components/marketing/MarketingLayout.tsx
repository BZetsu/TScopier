...
export function MarketingLayout({ children }: MarketingLayoutProps) {
  ...
  return (
    <div className="marketing-hero-bg flex min-h-screen flex-col">
      <MarketingHeader />

      <main className="relative z-10 flex-1 pt-[4.75rem] sm:pt-20">{children}</main>

      <footer className="relative z-10 border-t border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
