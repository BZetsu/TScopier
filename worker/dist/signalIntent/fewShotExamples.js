...
exports.STAGE_THREE_FEW_SHOTS = exports.STAGE_TWO_FEW_SHOTS = void 0;
exports.formatFewShots = formatFewShots;
function formatFewShots(examples) {
...
function intent(kind, side, symbol, entry, sl, tp, flags, confidence, overrides = {}) {
    return {
        kind,
        side,
        symbol,
