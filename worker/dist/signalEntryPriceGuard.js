...
exports.ENTRY_PRICE_MOVED_ADVERSE_REASON = void 0;
exports.entryPriceMovedAdverse = entryPriceMovedAdverse;
exports.ENTRY_PRICE_MOVED_ADVERSE_REASON = 'entry_price_moved_adverse';
function positive(v) {
    return typeof v === 'number' && Number.isFinite(v) && v > 0 ? v : null;
}
function parsePipSize(v) {
 ...
 */
function entryPriceMovedAdverse(args) {
