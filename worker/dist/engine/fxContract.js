...
exports.TSCOPIER_MAGIC = exports.BENIGN_MODIFY_RETCODES = exports.ORDER_NOT_PLACED_RETCODES = exports.PARTIAL_RETCODES = exports.DONE_RETCODES = exports.MT5_RETCODE = void 0;
exports.retcodeName = retcodeName;
exports.isInvalidStopsRetcode = isInvalidStopsRetcode;
exports.isRequoteRetcode = isRequoteRetcode;
exports.operationIsPending = operationIsPending;
exports.operationRequiresPrice = operationRequiresPrice;
exports.classifyOrderResponse = classifyOrderResponse;
exports.normalizeOpenOrder = normalizeOpenOrder;
exports.buildOrderComment = buildOrderComment;
exports.parseOrderComment = parseOrderComment;
...
const RETCODE_NAME = Object.fromEntries(Object.entries(exports.MT5_RETCODE).map(([k, v]) => [v, k]));
function retcodeName(retcode) {
    if (retcode == null)
        return 'UNKNOWN';
    return RETCODE_NAME[retcode] ?? `RETCODE_${retcode}`;
}
/** Retcodes that mean the broker fully accepted the request. */
exports.DONE_RETCODES = new Set([
    exports.MT5_RETCODE.DONE,
    exports.MT5_RETCODE.PLACED,
]);
/** Partial completion - the request did something but not everything (e.g. partial fill). */
exports.PARTIAL_RETCODES = new Set([
    exports.MT5_RETCODE.DONE_PARTIAL,
]);
/**
 ...
 */
exports.ORDER_NOT_PLACED_RETCODES = new Set([
    exports.MT5_RETCODE.REJECT,
    exports.MT5_RETCODE.CANCEL,
    exports.MT5_RETCODE.ERROR,
    exports.MT5_RETCODE.INVALID,
    exports.MT5_RETCODE.INVALID_VOLUME,
    exports.MT5_RETCODE.INVALID_PRICE,
    exports.MT5_RETCODE.INVALID_STOPS,
    exports.MT5_RETCODE.TRADE_DISABLED,
    exports.MT5_RETCODE.MARKET_CLOSED,
    exports.MT5_RETCODE.NO_MONEY,
    exports.MT5_RETCODE.INVALID_EXPIRATION,
    exports.MT5_RETCODE.SERVER_DISABLES_AT,
    exports.MT5_RETCODE.CLIENT_DISABLES_AT,
    exports.MT5_RETCODE.INVALID_FILL,
    exports.MT5_RETCODE.LIMIT_POSITIONS,
]);
/** "Already in the desired state" retcodes - treat a modify as a benign no-op success. */
exports.BENIGN_MODIFY_RETCODES = new Set([
    exports.MT5_RETCODE.NO_CHANGES,
]);
function isInvalidStopsRetcode(retcode) {
    return retcode === exports.MT5_RETCODE.INVALID_STOPS
        || retcode === exports.MT5_RETCODE.INVALID_PRICE
        || retcode === exports.MT5_RETCODE.PRICE_OFF;
}
function isRequoteRetcode(retcode) {
    return retcode === exports.MT5_RETCODE.REQUOTE || retcode === exports.MT5_RETCODE.PRICE_CHANGED;
}
function operationIsPending(op) {
    return /limit|stop/i.test(op);
}
function operationRequiresPrice(op) {
 ...
 */
function classifyOrderResponse(raw) {
    const root = (raw && typeof raw === 'object' ? raw : {});
    const body = (root.result && typeof root.result === 'object' ? root.result : root);
    const retcode = num(body.retcode ?? body.retCode ?? body.returnCode);
    const successField = body.success;
    const message = String(body.retcodeDescription ?? body.retCodeDescription ?? body.message ?? body.Message ?? '').trim();
    ...
    const retcodeOk = retcode != null && (exports.DONE_RETCODES.has(retcode) || exports.PARTIAL_RETCODES.has(retcode));
    ...
    return {
        ok,
        partial: retcode != null && exports.PARTIAL_RETCODES.has(retcode),
        retcode,
 ...
 */
function buildOrderComment(anchorSignalId, legIndex) {
