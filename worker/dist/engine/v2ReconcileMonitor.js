...
exports.closestLadderTp = closestLadderTp;
...
function buildDesiredLegTargets(args) {
    ...
    const explicitAdjustRevision = args.effectiveSource === 'basket_target' && args.basketTargetSource === 'adjust';
    const out = [];
