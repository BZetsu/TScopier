...
test('pipCalculator: XAUUSD 2-digit → pip=0.1, $10/std lot', () => {
...
test('pipCalculator: XAUUSD 5-digit → pip=0.1 (trader pip), $10/std lot', () => {
...
test('pipCalculator: exotic 10-oz XAUUSD contract → pip=0.1, $1/std lot', () => {
