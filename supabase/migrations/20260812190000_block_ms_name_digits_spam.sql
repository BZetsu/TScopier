/*
  Block bot pattern: letters+5+digits on Microsoft consumer mail
  (e.g. mamadou429302@hotmail.com) after pornhub/gaylord waves.
*/
...
BEGIN
  ...
  -- Keywords in local-part or domain
  ...
  -- mamadou429302@hotmail.com / same pattern on MS consumer domains
  IF domain_part IN (
    'hotmail.com',
    'outlook.com',
    'live.com',
...
COMMENT ON FUNCTION public.block_spam_auth_signup() IS
  'Rejects auth signups matching spam domains, keywords, MS name+digits bots, and emailSignupPolicy patterns.';
