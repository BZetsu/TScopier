/*
  Unblock hotmail.com, outlook.com, outlook.co.uk, proton.me for signup.
  Keep adult-domain, keyword, disposable, and MS name+digits spam rules.
*/
...
COMMENT ON FUNCTION public.block_spam_auth_signup() IS
  'Rejects spam signups (adult domains, keywords, disposable, MS name+digits). hotmail/outlook/proton are allowed.';
